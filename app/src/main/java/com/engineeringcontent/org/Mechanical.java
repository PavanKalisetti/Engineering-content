...
public class Mechanical extends AppCompatActivity implements RecyclerViewInterFace{
    ...
    private RecyclerView MechRecView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Mechanical Engineering");
        ...
        MechRecView = findViewById(R.id.MechRecView);
        ...
        Subject_branch_RecAdapter adapter = new Subject_branch_RecAdapter(Mechanical.this, this, 2);
        adapter.setBranch_SubjectNames(SubjectNames);
        adapter.setBranch_images(SubjectsImages);

        MechRecView.setAdapter(adapter);
        MechRecView.setLayoutManager(new GridLayoutManager(this, 2, RecyclerView.VERTICAL, false ));
        ...
        SemesterDropDown.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                SemesterAdapterItems = new ArrayAdapter<>(Mechanical.this, R.layout.dropdown_list_item, SemesterName);
                SemesterDropDown.setAdapter(SemesterAdapterItems);
    ...
    public void OnItemListener(int position) {
        ...
        Intent intent = new Intent(Mechanical.this, Chapters.class);
    ...
    public void statusBarIconsColor(){
        ...
        if (currentNightMode == Configuration.UI_MODE_NIGHT_YES) {
            ...
            if (getSupportActionBar() != null) {
                getSupportActionBar().setTitle(Html.fromHtml("<font color='#000000'>Mechanical Engineering</font>"));
    ...
    void dropdownSwitchStatement(int i){
        switch (i){
            case 0:
                Sem_pos = 0;
                SubjectNames = getResources().getStringArray(R.array.Mech_E1_S1);
            ...
            case 1:
                Sem_pos = 1;
                SubjectNames = getResources().getStringArray(R.array.Mech_E1_S2);
            ...
            case 2:
                Sem_pos = 2;
                SubjectNames = getResources().getStringArray(R.array.Mech_E2_S1);
            ...
            case 3:
                Sem_pos = 3;
                SubjectNames = getResources().getStringArray(R.array.Mech_E2_S2);
