...
public class Electronics_and_Communications extends AppCompatActivity implements RecyclerViewInterFace{
    ...
    private RecyclerView EceRecView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Objects.requireNonNull(getSupportActionBar()).setTitle("Electronics and Communications");
        setContentView(R.layout.electronics_and_communications);
        ...
        EceRecView = findViewById(R.id.EceRecyclerView);
        ...
        EceRecView.setLayoutManager(new GridLayoutManager(this, 2, RecyclerView.VERTICAL, false));
        ...
        SemesterDropDown.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                SemesterAdapterItems = new ArrayAdapter<>(Electronics_and_Communications.this, R.layout.dropdown_list_item, SemesterName);
                SemesterDropDown.setAdapter(SemesterAdapterItems);
    ...
    public void statusBarIconsColor(){
        ...
        if (currentNightMode == Configuration.UI_MODE_NIGHT_YES) {
            ...
            if (getSupportActionBar() != null) {
                getSupportActionBar().setTitle(Html.fromHtml("<font color='#000000'>Electronics and Communications</font>"));
    ...
    public void OnItemListener(int position) {
        ...
        if(Sem_pos == 0){
            Notes_db.setYear_Semester_db("E1S1");
            if(position == 0){
                Chapters.ChapterNames = new String[]{"Unit 1", "Unit 2", "Unit 3", "Unit 4", "Unit 5", "Unit 6", "Problems", "Formulas"};
            }
        }else if(Sem_pos == 1){
        ...
        Intent intent = new Intent(Electronics_and_Communications.this, Chapters.class);
    ...
    void dropdownSwitchStatement(int i){
        switch (i){
            case 0:
                Sem_pos = 0;
                SubjectNames = getResources().getStringArray(R.array.Ece_E1_S1);
                SubjectsImages = new int[]{R.drawable.maths,R.drawable.lightning_bolt, R.drawable.physics,R.drawable.c, R.drawable.electric_meter, R.drawable.beee, R.drawable.drawing, R.drawable.ic};
                SemesterDropDown.setText(getResources().getStringArray(R.array.Semester_Array)[0]);
                Notes_db.setYear_Semester_db("E1S1");
                break;
            case 1:
                Sem_pos = 1;
                SubjectNames = getResources().getStringArray(R.array.Ece_E1_S2);
                SubjectsImages = new int[]{R.drawable.maths,R.drawable.c, R.drawable.physics, R.drawable.lightning_bolt, R.drawable.networking};
                SemesterDropDown.setText(getResources().getStringArray(R.array.Semester_Array)[1]);
                Notes_db.setYear_Semester_db("E1S2");
                break;
            case 2:
                Sem_pos = 2;
                SubjectNames = getResources().getStringArray(R.array.Ece_E2_S1);
            ...
            case 3:
                Sem_pos = 3;
                SubjectNames = getResources().getStringArray(R.array.Ece_E2_S2);
