...
public class Civil extends AppCompatActivity implements RecyclerViewInterFace{
    ...
    private RecyclerView CivilRecView;
//    CivilRecyclerView

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        Objects.requireNonNull(getSupportActionBar()).setTitle("Civil Engineering");
        ...
        CivilRecView = findViewById(R.id.CivilRecyclerView);
        SemesterDropDown = findViewById(R.id.DropDownMenuCivil);
        ...
        Subject_branch_RecAdapter adapter = new Subject_branch_RecAdapter((Context) this, (RecyclerViewInterFace) this, 2);
        adapter.setBranch_SubjectNames(SubjectNames);
        adapter.setBranch_images(SubjectsImages);

        CivilRecView.setAdapter(adapter);
        CivilRecView.setLayoutManager(new GridLayoutManager(this, 2, RecyclerView.VERTICAL, false));
        ...
        SemesterDropDown.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                SemesterAdapterItems = new ArrayAdapter<>(Civil.this, R.layout.dropdown_list_item, SemesterName);
                SemesterDropDown.setAdapter(SemesterAdapterItems);
    ...
    public void statusBarIconsColor(){
        ...
        if (currentNightMode == Configuration.UI_MODE_NIGHT_YES) {
            ...
            if (getSupportActionBar() != null) {
                getSupportActionBar().setTitle(Html.fromHtml("<font color='#000000'>Civil Engineering</font>"));
    ...
    public void OnItemListener(int position) {
        ...
        Intent intent = new Intent(Civil.this, Chapters.class);
    ...
    void dropdownSwitchStatement(int i){
        switch (i){
            case 0:
                Sem_pos = 0;
                SubjectNames = getResources().getStringArray(R.array.CE_E1_S1);
                SubjectsImages = new int[]{R.drawable.maths, R.drawable.beee, R.drawable.c, R.drawable.drawing, R.drawable.ic, R.drawable.drawing, R.drawable.ic};
                SemesterDropDown.setText(getResources().getStringArray(R.array.Semester_Array)[0]);
                Notes_db.setYear_Semester_db("E1S1");
                break;
            case 1:
                Sem_pos = 1;
                SubjectNames = getResources().getStringArray(R.array.CE_E1_S2);
                SubjectsImages = new int[]{R.drawable.physics, R.drawable.maths, R.drawable.eee, R.drawable.mech,R.drawable.geology, R.drawable.environment};
                SemesterDropDown.setText(getResources().getStringArray(R.array.Semester_Array)[1]);
                Notes_db.setYear_Semester_db("E1S2");
                break;
            case 2:
                Sem_pos = 2;
                SubjectNames = getResources().getStringArray(R.array.CE_E2_S1);
                SubjectsImages = new int[]{R.drawable.maths, R.drawable.beee, R.drawable.c, R.drawable.drawing, R.drawable.ic,R.drawable.maths, R.drawable.physics, R.drawable.java, R.drawable.ds};
                SemesterDropDown.setText(getResources().getStringArray(R.array.Semester_Array)[2]);
                Notes_db.setYear_Semester_db("E2S1");
                break;
            case 3:
                Sem_pos = 3;
                SubjectNames = getResources().getStringArray(R.array.CE_E2_S2);
                SubjectsImages = new int[]{R.drawable.maths, R.drawable.beee, R.drawable.c, R.drawable.drawing, R.drawable.ic,R.drawable.maths, R.drawable.physics, R.drawable.java, R.drawable.ds};
